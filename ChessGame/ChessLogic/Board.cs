   ...
   public class Board
    {
        ...
        {
            return PiecePositions().Where(pos => this[pos].Colour == player);
        }
        ...
        private bool IsKingBishopVKingBishop(Counting counting)
        {
            ...
            return wBishopPos.SquareColour() == bBishopPos.SquareColour();
        }

        private Position FindPiece(Player colour, PieceType type)
        {
            return PiecePositionsFor(colour).First(pos => this[pos].Type == type);
        }
        ...
        private bool HasPawnInPosition(Player player, Position[] pawnPositions, Position skipPos)
        {
            ...
            {
                Piece piece = this[pos];
                if (piece == null || piece.Colour != player || piece.Type != PieceType.Pawn)
                {
                    continue;
                }
        ...
        public bool CanCaptureEnPassant(Player player)
        {
            ...
            {
                Player.White => new Position[] { skipPos + Direction.Down_Left, skipPos + Direction.Down_Right },
                Player.Black => new Position[] { skipPos + Direction.Up_Left, skipPos + Direction.Up_Right },
